...
class LmChatAzureOpenAiMsOAuth2 {
    ...
    async supplyData(itemIndex) {
        ...
        const instanceMethods = Object.getOwnPropertyNames(model).filter(m => typeof model[m] === 'function');
        const prototypeMethods = Object.getOwnPropertyNames(Object.getPrototypeOf(model)).filter(m => typeof model[m] === 'function');
        context.logger.info('Model methods:', {
            ...
            hasCall: typeof model.call === 'function',
        ...
        const originalCall = typeof model.call === 'function' ? model.call.bind(model) : null;
        const originalGenerate = typeof model.generate === 'function' ? model.generate.bind(model) : null;
        if (originalInvoke) {
