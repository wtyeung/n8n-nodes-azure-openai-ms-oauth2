...
- **Execution Logging**: Comprehensive input/output and token usage tracking
  - Logs input prompts sent to the model
  - Logs output responses generated by the model
  - Reports prompt tokens, completion tokens, and total tokens in execution logs
  - Logs errors for debugging
  - Helps monitor API costs, usage patterns, and debug workflows
  - Enabled for both streaming and non-streaming requests
  - Provides visibility similar to built-in chat model sub-nodes
